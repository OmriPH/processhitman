...
// Definitions for my sanity. 
// Ideally, I should have used classes or structs, but the GUI is simple enough, so we don't need it.
...
void CreateUIElements(HWND hwnd) {
    // The texts
    hwndLargeText = CreateWindowEx(0, "STATIC", "Process Hitman by zyapguy", WS_CHILD | WS_VISIBLE | SS_CENTER,
                                   0, 20, 400, 40, hwnd, NULL, NULL, NULL);
    SendMessage(hwndLargeText, WM_SETFONT, (WPARAM)hLargeFont, TRUE); // Apply large font

    hwndSmallText = CreateWindowEx(0, "STATIC", "Press Ctrl+T to hide to tray.", WS_CHILD | WS_VISIBLE | SS_CENTER,
                                   50, 50, 300, 20, hwnd, NULL, NULL, NULL);
    SendMessage(hwndSmallText, WM_SETFONT, (WPARAM)hSmallFont, TRUE); // Apply large font

    // Checkboxes
    hwndCheckbox1 = CreateWindowEx(0, "BUTTON", "Open on startup", WS_VISIBLE | WS_CHILD | BS_CHECKBOX,
                                   50, 70, 300, 20, hwnd, (HMENU)ID_CHECKBOX1, NULL, NULL);
    hwndCheckbox2 = CreateWindowEx(0, "BUTTON", "Start hidden", WS_VISIBLE | WS_CHILD | BS_CHECKBOX,
                                   50, 100, 300, 20, hwnd, (HMENU)ID_CHECKBOX2, NULL, NULL);
    hwndCheckbox3 = CreateWindowEx(0, "BUTTON", "Enable on start", WS_VISIBLE | WS_CHILD | BS_CHECKBOX,
                                   50, 130, 300, 20, hwnd, (HMENU)ID_CHECKBOX3, NULL, NULL);
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow) {
    ...
    // Create the window
    hwnd = CreateWindowEx(0, CLASS_NAME, "Process Hitman | Alt + F5 to kill processes", WS_OVERLAPPEDWINDOW,
